...
\begin{Solution}
    \begin{tikzpicture}[shorten >=1pt, node distance=2cm, on grid, auto, initial text =]
        ...
        \node[state]            (2a)[right=of 2]        {};
        \node[state]            (3)[right=of 2a]        {};
        \node[state]            (3a)[right=of 3]        {};
        \node[state]            (4)[right=of 3a]         {};
        \node[state, accepting, thick, double, double distance=2pt]            (5)[right=of 4]         {};
        \node[state]            (6)[below=of 3]         {};

        \path[->]
        (1) edge node {$b$} (2)
        (2) edge node {$b$} (2a)
        (2a) edge node {$\epsilon$} (3)
        (3) edge node {$\epsilon$} (3a)
        (3a) edge node {$a$} (4)
        (4) edge node {$a$} (5)
